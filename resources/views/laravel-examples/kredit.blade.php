            ...
            <div class="card mb-4 mx-4">
                <div class="card-header pb-3 p-3">
                    <div class="d-flex flex-row justify-content-between align-items-center" style="height: 40,4px;">
                        <div>
                            <h5 class="mb-0 mx-2">Manajemen Kredit</h5>
                        </div>
                        <div class="d-flex align-items-center">
                            <form method="GET" action="{{ route('kredit.index') }}" class="d-flex align-items-center">
                                ...
                                <button class="btn bg-gradient-primary mb-0 d-flex align-items-center" type="button" data-bs-toggle="modal" data-bs-target="#addKreditModal">
