                  ...
                  <p class="mb-0">Password <b>secret</b></p> -->
                            ...
                            <div class="card-body">
                                <form role="form" method="POST" action="/session">
                                    ...
                                    <label>Email</label>
                                    <div class="mb-3">
                                        <input type="email" class="form-control" name="email" id="email" placeholder="Email" value="putra.manuaba@penggilingan.padi.my.id" aria-label="Email" aria-describedby="email-addon">
                                        @error('email')
                                    ...
                                    <div class="mb-3">
                                        <input type="password" class="form-control" name="password" id="password" placeholder="Password" value="ida.bagus.putra.manuaba" aria-label="Password" aria-describedby="password-addon">
                                        @error('password')
                                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                        @enderror
                                    </div>
